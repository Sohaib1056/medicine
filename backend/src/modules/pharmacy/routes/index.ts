...
import * as AuditAnalytics from '../controllers/audit_analytics.controller'
...
r.get('/customers/:id/history', Customers.getHistory)
r.get('/customers/by-phone/:phone', Customers.getByPhone)
...
r.get('/audit/analytics', AuditAnalytics.getAnalytics)
r.get('/audit/top-items', AuditAnalytics.getTopItems)
r.get('/audit/sale/:id', AuditAnalytics.getSaleDetail)
r.get('/audit/purchase/:id', AuditAnalytics.getPurchaseDetail)
r.get('/audit/inventory/:id', AuditAnalytics.getInventoryDetail)
...
r.post('/purchase-drafts/:id/lines/:lineId/approve', Drafts.approveLine)
r.delete('/purchase-drafts/:id/lines/:lineId', Drafts.rejectLine)
r.delete('/purchase-drafts/:id', Drafts.remove)

// Image upload
r.post('/inventory/upload-image', Upload.uploadImage)

// Inventory items (aggregated store)
r.get('/inventory/manufacturers', InventoryItems.listManufacturers)
...
r.post('/inventory/adjust', InventoryItems.adjust)
...
// Public products API (no auth) for external website
...
r.get('/purchase-orders/inventory-suggestions', PurchaseOrders.inventorySuggestions)
r.get('/purchase-orders/summary', PurchaseOrders.summary)
...
r.post('/purchase-orders/:id/send', PurchaseOrders.send)
r.post('/purchase-orders/:id/confirm', PurchaseOrders.confirm)
r.post('/purchase-orders/:id/receive', PurchaseOrders.receive)
r.post('/purchase-orders/:id/cancel', PurchaseOrders.cancel)
