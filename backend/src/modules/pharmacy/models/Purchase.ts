...
const PurchaseSchema = new Schema({
  ...
  sourceType: { type: String }, // 'PO' etc
  sourceRef: { type: String },  // poNumber
  totals: {
...
export const Purchase = (models.Pharmacy_Purchase || model('Pharmacy_Purchase', PurchaseSchema)) as any
