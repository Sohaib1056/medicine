...
import * as DoctorTemplates from '../controllers/doctor_templates.controller'
...
// Doctor Templates
r.get('/doctors/:doctorId/templates', DoctorTemplates.list)
r.post('/doctors/:doctorId/templates', DoctorTemplates.create)
r.put('/doctors/:doctorId/templates/:id', DoctorTemplates.update)
r.delete('/doctors/:doctorId/templates/:id', DoctorTemplates.remove)
// Fallback routes to support older clients
r.get('/doctor-templates', DoctorTemplates.list)
r.post('/doctor-templates', DoctorTemplates.create)
r.put('/doctor-templates/:id', DoctorTemplates.update)
r.delete('/doctor-templates/:id', DoctorTemplates.remove)
// Doctor Schedules
...
r.get('/opd/prescriptions/by-encounter', Prescriptions.byEncounterQuery)
...
// Encounter scoped helpers
r.get('/opd/encounters/:encounterId/prescription', Prescriptions.getByEncounter)
r.put('/opd/encounters/:encounterId/prescription', Prescriptions.upsertForEncounter)
...
r.post('/er/encounters/:encounterId/billing/payments', ERBilling.createPayment)
...
r.get('/er/tokens/:id/discharge-summary', ErDocs.getDischargeSummary)
r.put('/er/tokens/:id/discharge-summary', ErDocs.upsertDischargeSummary)
r.get('/er/tokens/:id/discharge-summary/print', ErDocs.printDischargeSummary)
r.get('/er/tokens/:id/discharge-summary/print-pdf', ErDocs.printDischargeSummaryPdf)
r.delete('/er/tokens/:id/discharge-summary', ErDocs.deleteDischargeSummary)

// ER Short Stay
r.get('/er/tokens/:id/short-stay', ErDocs.getShortStay)
r.put('/er/tokens/:id/short-stay', ErDocs.upsertShortStay)
r.delete('/er/tokens/:id/short-stay', ErDocs.deleteShortStay)

// ER Death Certificate
r.get('/er/tokens/:id/death-certificate', ErDocs.getDeathCertificate)
r.put('/er/tokens/:id/death-certificate', ErDocs.upsertDeathCertificate)
r.get('/er/tokens/:id/death-certificate/print', ErDocs.printDeathCertificate)
r.get('/er/tokens/:id/death-certificate/print-pdf', ErDocs.printDeathCertificatePdf)
r.delete('/er/tokens/:id/death-certificate', ErDocs.deleteDeathCertificate)

// ER Birth Certificate
r.get('/er/tokens/:id/birth-certificate', ErDocs.getBirthCertificate)
r.put('/er/tokens/:id/birth-certificate', ErDocs.upsertBirthCertificate)
r.get('/er/tokens/:id/birth-certificate/print', ErDocs.printBirthCertificate)
r.get('/er/tokens/:id/birth-certificate/print-pdf', ErDocs.printBirthCertificatePdf)
r.delete('/er/tokens/:id/birth-certificate', ErDocs.deleteBirthCertificate)

// ER Received Death
r.get('/er/tokens/:id/received-death', ErDocs.getReceivedDeath)
r.put('/er/tokens/:id/received-death', ErDocs.upsertReceivedDeath)
r.get('/er/tokens/:id/received-death/print', ErDocs.printReceivedDeath)
r.get('/er/tokens/:id/received-death/print-pdf', ErDocs.printReceivedDeathPdf)
r.delete('/er/tokens/:id/received-death', ErDocs.deleteReceivedDeath)

// ER Forms: Lists
r.get('/er/forms/received-deaths', ErDocs.listReceivedDeaths)
r.get('/er/forms/death-certificates', ErDocs.listDeathCertificates)
r.get('/er/forms/birth-certificates', ErDocs.listBirthCertificates)
r.get('/er/forms/short-stays', ErDocs.listShortStays)
r.get('/er/forms/discharge-summaries', ErDocs.listDischargeSummaries)
// ER Forms: Standalone Birth Certificates (no token required)
r.post('/er/forms/birth-certificates', ErDocs.createBirthCertificateStandalone)
r.get('/er/forms/birth-certificates/:id', ErDocs.getBirthCertificateById)
r.put('/er/forms/birth-certificates/:id', ErDocs.updateBirthCertificateStandalone)
r.delete('/er/forms/birth-certificates/:id', ErDocs.deleteBirthCertificateById)
// ER Forms: Final Invoices (token-based)
r.get('/er/tokens/:id/final-invoice', ErDocs.getFinalInvoice)
r.put('/er/tokens/:id/final-invoice', ErDocs.upsertFinalInvoice)
r.delete('/er/tokens/:id/final-invoice', ErDocs.deleteFinalInvoice)
// ER Forms: Standalone Final Invoices (no token required)
r.post('/er/forms/final-invoices', ErDocs.createFinalInvoiceStandalone)
r.get('/er/forms/final-invoices/:id', ErDocs.getFinalInvoiceById)
r.put('/er/forms/final-invoices/:id', ErDocs.updateFinalInvoiceStandalone)
r.delete('/er/forms/final-invoices/:id', ErDocs.deleteFinalInvoiceById)
r.get('/er/forms/final-invoices', ErDocs.listFinalInvoices)
