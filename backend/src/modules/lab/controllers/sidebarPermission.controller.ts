...
const defaultSidebarItems = [
  ...
  { path: '/lab/tracking', label: 'Sample Tracking', order: 4 },
  { path: '/lab/barcodes', label: 'Barcodes', order: 5 },
  { path: '/lab/results', label: 'Result Entry', order: 6 },
  { path: '/lab/reports', label: 'Reports Generator', order: 7 },
  { path: '/lab/settings', label: 'Settings', order: 8 },
  { path: '/lab/income-ledger', label: 'Income Ledger', order: 9 },
  { path: '/lab/tests', label: 'Test Catalog', order: 10 },
  { path: '/lab/patient-profiling', label: 'Patient Profiling', order: 11 },
  { path: '/lab/report-approval', label: 'Report Approval', order: 12 },
  { path: '/lab/referrals', label: 'Referrals', order: 13 },
  { path: '/lab/reports-summary', label: 'Reports', order: 14 },
  { path: '/lab/inventory', label: 'Inventory', order: 15 },
  { path: '/lab/suppliers', label: 'Suppliers', order: 16 },
  { path: '/lab/purchase-history', label: 'Purchase History', order: 17 },
  { path: '/lab/supplier-returns', label: 'Supplier Returns', order: 18 },
  { path: '/lab/return-history', label: 'Return History', order: 19 },
  { path: '/lab/bb/donors', label: 'BB • Donors', order: 20 },
  { path: '/lab/bb/inventory', label: 'BB • Inventory', order: 21 },
  { path: '/lab/bb/receivers', label: 'BB • Receivers', order: 22 },
  { path: '/lab/staff-attendance', label: 'Staff Attendance', order: 23 },
  { path: '/lab/staff-management', label: 'Staff Management', order: 24 },
  { path: '/lab/staff-settings', label: 'Staff Settings', order: 25 },
  { path: '/lab/staff-monthly', label: 'Staff Monthly', order: 26 },
  { path: '/lab/expenses', label: 'Expenses', order: 27 },
  { path: '/lab/pay-in-out', label: 'Pay In / Out', order: 28 },
  { path: '/lab/manager-cash-count', label: 'Manager Cash Count', order: 29 },
  { path: '/lab/audit-logs', label: 'Audit Logs', order: 30 },
  { path: '/lab/user-management', label: 'User Management', order: 31 },
  { path: '/lab/sidebar-permissions', label: 'Sidebar Permissions', order: 32 },
]
