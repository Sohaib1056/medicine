...
export async function update(req: Request, res: Response){
  ...
  if (data.pmdcNumber != null) patch.pmdcNumber = String(data.pmdcNumber || '')
  if (data.digitalSignatureDataUrl != null) patch.digitalSignatureDataUrl = String(data.digitalSignatureDataUrl || '')
...
export async function login(req: Request, res: Response){
  ...
  res.json({ user: { id: String(u._id), username: u.username, role: u.role, pmdcNumber: u.pmdcNumber || '', digitalSignatureDataUrl: u.digitalSignatureDataUrl || '' } })
}
