// Script to add more sample medicines (without checking existing)
...
const moreMedicines = [
  ...
  },
  {
    ...
    narcotic: false,
    image: "",
    description: "Fast-acting pain relief. Soluble tablets.",
...
async function addMoreMedicines() {
  ...
  try {
    ...
    // Insert medicines
    const result = await collection.insertMany(moreMedicines);
    console.log(`✅ Successfully inserted ${result.insertedCount} medicines!`);
