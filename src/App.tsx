...
import Lab_PatientProfiling from './pages/lab/lab_PatientProfiling'
...
import Pharmacy_AddItem from './pages/pharmacy/pharmacy_AddItem'
...
import Pharmacy_PurchaseOrdersPage from './pages/pharmacy/PurchaseOrdersPage'
import Pharmacy_Audit from './pages/pharmacy/pharmacy_Audit'
  ...
  return (
    <HospitalSettingsProvider>
      ...
      <Route path="/lab" element={<Lab_Layout />}>
        ...
        <Route path="patient-profiling" element={<Lab_PatientProfiling />} />
      ...
      <Route path="/pharmacy" element={<Pharmacy_Layout />}>
        ...
        <Route path="inventory/add-item" element={<Pharmacy_AddItem />} />
        ...
        <Route path="purchase-orders" element={<Pharmacy_PurchaseOrdersPage />} />
        ...
        <Route path="audit" element={<Pharmacy_Audit />} />
