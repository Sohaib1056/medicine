...
import { LogOut, BarChart3, Users, Activity, FileText, BookOpen, Receipt, Repeat, Scale, Store, Settings } from 'lucide-react'
    ...
    >
      <nav className={`scrollbar-hide-on-hover flex-1 overflow-y-auto ${collapsed ? 'p-2' : 'p-3'} space-y-1`}>
        ...
        <div className={collapsed ? 'mt-2 mb-2' : 'mt-4 mb-2'}>
          <SwitchPortal collapsed={collapsed} currentPortal="finance" />
        </div>
        <button
          onClick={logout}
