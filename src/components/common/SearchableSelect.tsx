...
export default function SearchableSelect({ value, onChange, options, placeholder = 'Type to search...', disabled, className, inputId, autoFocus, onFocus, onKeyDown }: Props) {
