...
import { Stethoscope, Pill, FileText, PhoneIncoming } from 'lucide-react'
    ...
    <div className="min-h-dvh relative overflow-hidden flex flex-col">
      ...
      <header className="relative z-10 mx-auto max-w-6xl px-6 pt-12 text-center home-hero">
        <div ref={heroRef} onMouseMove={onHeroMove} onMouseLeave={onHeroLeave} className="home-hero-tilt mx-auto">
          ...
          <p className="mt-3 text-slate-600" style={{ transform: 'translateZ(24px)' }}>Complete Hospital Management System</p>
        </div>
      </header>

      <main className="relative z-10 mx-auto max-w-6xl px-6 py-10 flex-grow">
      ...
      <footer className="relative z-10 py-8 text-center text-black font-semibold text-sm">
        © Developed by Healthspire. All Rights Reserved
      </footer>
    </div>
  )
}
