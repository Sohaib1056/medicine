...
export default function Hospital_CorporateClaims(){
  ...
  async function generate(){
    ...
    try {
      ...
      await load()
      setToast({ type: 'success', message: 'Claim generated' })
  ...
  return (
    ...
    <ConfirmDialog
      ...
      title="Confirm"
      message={confirmDelete?.claim ? `Delete claim ${confirmDelete.claim.claimNo || String((confirmDelete.claim as any)._id).slice(-6)}? This cannot be undone.` : 'Delete this claim?'}
      confirmText="Delete"
