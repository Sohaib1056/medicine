...
export default function Pharmacy_PayInOut(){
  ...
  useEffect(() => {
    const t = setTimeout(() => { (document.getElementById('pharmacy-pay-in-out-date') as HTMLInputElement | null)?.focus() }, 0)
      ...
      <div className="mt-3 rounded-xl border border-slate-200 bg-white p-3 sm:p-4">
        <div className="grid gap-2 sm:grid-cols-7">
          <div>
            ...
            <input id="pharmacy-pay-in-out-date" type="date" value={date} onChange={e=>setDate(e.target.value)} className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900" />
          </div>
          <div>
