        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="inline-flex rounded-lg border border-slate-200 bg-slate-50 p-1">
            <button
              ...
              className={`rounded-md px-3 py-1 text-sm font-medium transition-colors ${filter === 'all' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'}`}
            >
              All
            </button>
            <button
              onClick={() => { setPage(1); setFilter('unread') }}
              className={`rounded-md px-3 py-1 text-sm font-medium transition-colors ${filter === 'unread' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'}`}
            >
              Unread
            </button>
          </div>
