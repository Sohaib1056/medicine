    ...
    <div className="space-y-4 p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button ref={addButtonRef} type="button" onClick={()=>setAddOpen(true)} className="btn">+ Add Company</button>
        </div>
      </div>

      <div className="rounded-xl border border-slate-200 bg-white p-3">
        <div className="flex items-center gap-3">
          <input id="pharmacy-companies-search" value={query} onChange={e=>{ setQuery(e.target.value); setPage(1) }} placeholder="Search companies.." className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900" />
