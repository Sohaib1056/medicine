...
export default function Pharmacy_Dashboard() {
  ...
  useEffect(()=>{
    ...
    window.addEventListener('pharmacy:dashboard:refresh', onRefresh)

    return ()=>{ 
      window.removeEventListener('pharmacy:sale', onSale as any)
      window.removeEventListener('pharmacy:dashboard:refresh', onRefresh)
    }
  }, [])
