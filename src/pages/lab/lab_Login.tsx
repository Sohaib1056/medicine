  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        localStorage.setItem('lab.session', JSON.stringify({ username: user.username || uname, role: user.role || 'Lab', id: user.id || user._id, pmdcNumber: user.pmdcNumber || '', digitalSignatureDataUrl: user.digitalSignatureDataUrl || '' }))
      } catch {}
      navigate('/lab')
    } catch (err: any) {
