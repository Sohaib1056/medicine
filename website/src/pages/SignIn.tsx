...
import { ArrowLeft, Eye, EyeOff, Mail, Lock, Shield, Clock, Headphones } from 'lucide-react';
...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#00A651]/5 via-[#00BFA5]/5 to-[#E0F7FA] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#00A651]/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#00BFA5]/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
                  id="remember"
                  className="w-4 h-4 text-[#00A651] border-gray-300 rounded focus:ring-[#00A651] cursor-pointer"
                />
                <label htmlFor="remember" className="text-sm text-gray-600 cursor-pointer select-none">
                  Remember me
                </label>
              </div>
              <Link to="#" className="text-sm text-[#00A651] hover:text-[#008f47] font-semibold transition-colors">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/signup" className="text-[#00A651] hover:text-[#008f47] font-bold transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-8 text-sm">
          ...
          <div className="flex items-center gap-2 text-gray-600 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full">
            <Headphones className="text-[#00A651]" size={18} />
